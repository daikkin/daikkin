var myProjects = [
	...
	},
	{
		...
		"technologies_used": [
			"PHP (Laravel Framework)", "JavaScript (Native, jQuery Library, DataTables.js, Chart.js)", "CSS (Bootstrap)", "ScrapeStorm (Web scraper)", "MySQL"
		],
		"project_images": [
	...
	},
	{
		...
		"project_main_image": "assets/abdalhr/pdf_generated.png",
		"technologies_used": [],
		"project_images": [],
	},
	{
	...
	},
	{
		...
		"technologies_used": [
			"Python", "Jinja", "CSS (Bootstrap)", "JavaScript", "SocketIO", "MySQL", "OrangePi (Linux-based OS)"
		],
		"project_images": [
	...
	},
	{
		...
		"technologies_used": [
			"Python", "Jinja", "CSS (Bootstrap)", "JavaScript", "SocketIO", "MySQL", "RaspberryPi (Linux-based OS)"
		],
		"project_images": [
...
var myLanguages = [
	"PHP (Native and Frameworks)", "JavaScript (Native, Libraries and Frameworks)", "Python (Jinja, Flask, SQLAlchemy, and other modules...)", "Node.js", "C# Programming Language", "PowerBuilder", "VisualBasic", "Java", "C", "C++", "Cascading Style Sheets (CSS)"
];
